...
export default function DashboardPage() {
  ...
  const { totalPnl, chartData, pendentesCount, isLoading, isError } = useDashboard(period, customRange)
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6 space-y-4">
      <div className="flex items-start justify-between">
        <span className="text-xs font-mono font-bold text-slate-600 uppercase tracking-widest mt-2">Dashboard</span>
        <PeriodToggle
          value={period}
          onChange={setPeriod}
